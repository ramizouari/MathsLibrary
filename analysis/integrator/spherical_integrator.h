...
namespace math_rz {
	...
	class spherical_integrator :public  integrator<Lp_finite_dimensional_space<real_field,p,3>, F>
	{
		...
		integrator<Lp2, F>& I;
	public:
		spherical_integrator(integrator<Lp2, F>& _I, real_field r = 1) :I(_I), R(r)
		{
		...
		{
			return I.integrate(general_function<Lp2, F>([&](const Lp2& s)->F {
